...
| 11 | Κατασκευή του βιβλίου Β | | Έχει γίνει το 100% των απαιτούμενων εργασιών της τρέχουσας εβδομάδας |
| 12 | Τελική αναφορά* | | |
...
Πρόσθεσα τις εικόνες μου από το τρίτο παραδοτέο, την μελέτη περίπτωσής μου από το 7ο παραδοτέο και την βιογραφία από το 9ο παραδοτέο στο κεφάλαιο `μοντέλα`. Πιο συγκεκριμένα πρόσθεσα στο υποκεφάλαιο `Εργαλείο` την εικόνα της unreal engine 3 δίοτι αναφερότανε για παιχνιδομηχανές,  
