...
Για αυτό το παραδοτέο έφτιαξα ένα ακόμα `shell script` το οποίο ζητάει αρχικά από τον χρήστη το όνομα του `C/C++` αρχείου που θέλει να δημιουργήσει, ελέγχει αν υπάρχει ήδη αυτό το αρχείο και, αν ναι, το διαγράφει φτιάχνοντας ξανά καινούργιο ώστε να είναι άδειο και το ανοίγει με `vim` ώστε να το επεξεργαστεί ο χρήστης. Αφού γράψει τον κώδικά του ο χρήστης τότε φτιάχνει ένα άδειο αρχείο `.txt` το οποίο μέσα σε αυτό θα περιέχει το `αποτέλεσμα του compiler` και αυτό πραγματοποιήθηκε μέσω της χρήσης `pipelining`. Τέλος, ανοίγει το αρχείο .txt, δείχνοντας με αυτόν τον τρόπο στον χρήστη το αποτέλεσμα του `C/C++` προγράμματός του.
