...
| 9 | <ul><li> [x] <a href="#B2">Συμμετοχικό περιεχόμενο B2 </a></ul></li> | [Ανέβασμα στο σχολιασμό της συζήτησης το Παραδοτέο 9](https://github.com/courses-ionio/help/discussions/1802) | Έχει γίνει το 100% των απαιτούμενων εργασιών της τρέχουσας εβδομάδας |
| 10 |  <ul><li> [x] <a href="#pipelining">Άσκηση γραμμής εντολών 2 (pipelining + Shell Scripts) </a></ul></li> <ul><li> [x] Απάντηση στων ερωτήσεων του 10ου βίντεο που υπάρχει στο Edpuzzle </ul></li> | [Ανέβασμα στο σχολιασμό της συζήτησης το Παραδοτέο 10](https://github.com/courses-ionio/help/discussions/1803) | Έχει γίνει το 100% των απαιτούμενων εργασιών της τρέχουσας εβδομάδας |
| 11 | <ul><li> [x] <a href="#BOOK_B">Κατασκευή του βιβλίου Β</a></ul></li> <ul><li> [x] Απάντηση στων ερωτήσεων του 11ου βίντεο που υπάρχει στο Edpuzzle </ul></li> | [Ανέβασμα στο σχολιασμό της συζήτησης το Παραδοτέο 11](https://github.com/courses-ionio/help/discussions/1815)  | Έχει γίνει το 100% των απαιτούμενων εργασιών της τρέχουσας εβδομάδας |
| 12 | <ul><li> [ ] <a href="#final_report">Τελική αναφορά </a> </ul></li> | | |
...
## <h2 id="aks3"> Αυτοξιολόγηση: `βαθμός 8/10`</h2>
...
## <h2 id="aks6"> Αυτοξιολόγηση: `βαθμός 9/10`</h2>
...
## <h2 id="bibliography7"> Links από την `βιβλιογραφία` που χρησιμοποίησα για να βρω πληροφορίες για το θέμα που επέλεξα:</h2>
 ...
 ## <h2 id="aks7"> Αυτοξιολόγηση: `βαθμός 10/10`</h2>
...
### Την `αναφορά` μου το shell script την μετατρέπει σε αρχείο:
 ...
 - ipynb: [`myReport.ipynb`](https://github.com/nkanagno/paradoteo-8/blob/main/myReport.ipynb)
  ...
  ## <h2 id="aks8"> Αυτοξιολόγηση: `βαθμός 10/10`</h2>
Στο παραδοτέο αυτό πραγματοποιήθηκαν όλα τα ζητούμενα εμπρόθεσμα. Δηλαδή, έγινε επιτυχώς μία από τις 4 ασκήσεις εντολών hci χρησιμοποιώντας shell script. Μέσω αυτού του παραδοτέου βελτιώθηκα πιο έντονα στον 1ο στόχο της εισαγωγής που αφορά το να έχω ένα πιο οργανωμένο portfolio github. Έπειτα ανέβασα εμπρόθεσμα το παραδοτέο 8 στη συζήτηση [#1741](https://github.com/courses-ionio/help/discussions/1741). Τέλος, έκανα το βίντεο του edpuzzle εμπρόθεσμα.
...
## <h2 id="bibliography9"> Links από την `βιβλιογραφία` που χρησιμοποίησα για να βρω πληροφορίες για το θέμα που επέλεξα:</h2>
 ...
 ## <h2 id="aks9"> Αυτοξιολόγηση: `βαθμός 10/10`</h2>
...
- [`random_pass.cpp`](https://github.com/nkanagno/paradoteo-10/blob/main/random_pass.cpp)
  ...
  ## <h2 id="aks10"> Αυτοξιολόγηση: `βαθμός 10/10`</h2>
Στο παραδοτέο αυτό πραγματοποιήθηκαν όλα τα ζητούμενα εμπρόθεσμα. Δηλαδή, έγινε επιτυχώς μια ακόμη από τις 4 ασκήσεις εντολών hci χρησιμοποιώντας shell script και pipelinings. Μέσω αυτού του παραδοτέου βελτιώθηκα πιο έντονα στον 1ο στόχο της εισαγωγής που αφορά το να έχω ένα πιο οργανωμένο portfolio github. Έπειτα ανέβασα εμπρόθεσμα το παραδοτέο 8 στη συζήτηση [#1803](https://github.com/courses-ionio/help/discussions/1803). Τέλος, έκανα το βίντεο του edpuzzle εμπρόθεσμα.
...
## <h2 id="aks11"> Αυτοξιολόγηση: `βαθμός 10/10`</h2>
Στο παραδοτέο αυτό πραγματοποιήθηκαν όλα τα ζητούμενα εμπρόθεσμα. Δηλαδή, έγινε επιτυχώς η κατασκευή του βιβλίου Β σε epub μορφή μέσω pandoc, και πρόσθεσα όλες τις εικόνες μου, μελέτη περίπτωσης και βιογραφία στο κεφάλαιο **Τεχνικές** και <a href="#addition">εδώ</a> εξηγώ γιατί. Ανέβασα εμπρόθεσμα το παραδοτέο 11 στη συζήτηση [#1815](https://github.com/courses-ionio/help/discussions/1815). Τέλος, έκανα το βίντεο του edpuzzle εμπρόθεσμα.
...
## Συνολική Aυτοαξιολόγηση: `Βαθμός:9.6/10`
...
## Συμπέρασματα:
Φτάνοντας στο τέλος αυτού του μαθήματος, μπορώ να πω με σιγουριά ότι το μεγαλύτερο μέρος των στόχων μου ολοκληρώθηκε επιτυχώς.
