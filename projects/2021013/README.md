...
Μέσω του μαθήματος Επικοινωνία Ανθρώπου – Υπολογιστή, ως φοιτητής του ιονίου πανεπιστημίου στο τμήμα πληροφορικής ευελπιστώ να εξοικιωθώ στα παρακάτω:
 ...
 - Στις command-line εντολές, όπως του λογισμικού arch-linux, ο οποίες λειτουργούν διαφορετικά με τις σύγχρονες γλώσσες προγραμματισμού αλλά είναι εξίσου σημαντικές για ένα προγραμματιστή. 

 - Στο να έχω καλύτερη κατανόηση και να δίνω περισσότερη προσοχή στο οτιδήποτε παρακολουθώ, διαβάζω και ακούω, όχι μόνο στο διαδίκτυο αλλά και στην καθημερινή μου ζωή το οποίο πιστεύω θα  το πετύχω μέσα από τα εβδομαδιαία βιντεάκια μικρού μήκους, που θα παρακολουθώ μέσω της πλατφόρμας Edpuzzle. 
...
ν όπου χρησιμοποιήτε κυριώς για σχεδίαση γραφικών, τρισδιάστατο και δισδιάστατο animation καθώς και video editing.
...
1. Δείχνω τον καιρό της κέρκυρας και της ισπανίας: <a href="https://asciinema.org/a/533580">`wttr`</a>             <br>
