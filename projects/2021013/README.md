...
| 12 | <ul><li> [ ] <a href="#final_report">Τελική αναφορά </a> </ul></li> | | `Βαθμός:9.6/10` <br> <a href="#aks12">Τελική αυταξιολόγηση</a> |
...
Στο παραδοτέο αυτό πραγματοποιήθηκαν όλα τα ζητούμενα εμπρόθεσμα. Δηλαδή, έγινε επιτυχώς μια ακόμη από τις 4 ασκήσεις εντολών hci χρησιμοποιώντας shell script και pipelinings. Τέλος ανέβασα εμπρόθεσμα το παραδοτέο 8 στη συζήτηση [#1803](https://github.com/courses-ionio/help/discussions/1803).
